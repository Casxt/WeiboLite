        ...
        <div class="card-body">
            <form id="signIn-Form">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control rounded-0" id="signIn-NickName" placeholder="NickName email"
                           required>
                </div>

                <div class="form-group">
                    <label for="signIn-Password">密码</label>
                    <input type="password" class="form-control rounded-0" id="signIn-Password" placeholder="Password"
                           required>
                </div>
                ...
                <button id="SignIn-SignInButton" type="button" class="btn btn-primary rounded-0 float-right"
                        onclick="document.getElementById('SignIn-ResetPassword').removeAttribute('hidden');this.innerHTML='密码错误';">
                    登陆
                </button>
            </form>
